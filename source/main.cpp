...
int main(int argc, char const* argv[]) {
  ...
  lights.push_back(std::make_unique<ray::Light>(ray::Light({{-10.0, 0.0, 5.0}}, {1.0, 0.0, 0.0}, 10)));
  lights.push_back(std::make_unique<ray::Light>(ray::Light({{10.0, 0.0, 5.0}}, {0.0, 0.0, 1.0}, 10)));
  lights.push_back(std::make_unique<ray::Light>(ray::Light({{0.0, 10.0, 5.0}}, {0.0, 1.0, 0.0}, 10)));
  // lights.push_back(std::make_unique<ray::Light>(ray::Light({{100.0, 100.0, -100.0}}, {1.0, 1.0, 1.0}, 10)));
  // objs.push_back(ray::GenerateSphere(1, 10));
  objs[0]->Translate(0, 0, 5);
  objs[0]->sphere = true;
